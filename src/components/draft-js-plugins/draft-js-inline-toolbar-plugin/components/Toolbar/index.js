...
export default class Toolbar extends React.Component {
  ...
  onSelectionChanged = () => {
    ...
    setTimeout(() => {
      ...
      // console.log(editorRoot.parentNode, 'editorRoot.parentNode');
      // console.log(editorRoot.parentNode.scrollTop, 'editorRoot.parentNode.scrollTop');
      // console.log(editorRoot.scrollTop, 'editorRoot.scrollTop');
      // console.log(editorRoot.parentNode.parentNode.parentNode.parentNode.scrollTop, 'editorRoot.parentNode.scrollTop');

      var scrollTop = 0;
      var currentNode = editorRoot.parentNode;
      while(true) {
